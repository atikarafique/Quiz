...
<head>
<link rel="icon" href="download.jpg" type="image/icon" sizes="16x16">
...
?>>Information and communication technology</option>
  <option value="dld" <?php
  if (isset($_GET['branch']))
  {
if ($_GET['branch'] == "dld")
    echo "selected";
  }
?>>digital logic design</option>
  <option value="GK" <?php
  if (isset($_GET['branch']))
  {
  if ($_GET['branch'] == "GK")
...
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Created by: team AAQ<br><br></span>
</div>
